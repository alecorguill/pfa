...
public class Value {
	...
	//This works because for a straight flush we only need 
	//to save the highest card of the straight. The function
	//isStraight does this so by checking it after isFlush()
	//we get what we want in data
